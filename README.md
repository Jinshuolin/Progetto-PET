...
L'ultimo metodo permette, insieme alle funzioni presenti nel file pixelf.py, di inziare la diagnosi del paziente e di stimare con precisione la posizione dell'organo, che è stato approssimato a punto.
